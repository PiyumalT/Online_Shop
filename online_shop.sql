...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 06, 2023 at 10:31 AM
...
INSERT INTO `item` (`item_id`, `name`, `description`, `price`, `options`, `qty`) VALUES
(1, 'sample toy car', 'remote control toy car for children and adults. brand-new toy car. rechargeable battery up to 5 hours works', 2500, 'red, blue, green, yellow , black , white', 50),
(0, 'Sorry, invalid Item.', 'Unavailable item', 0, 'default ', 0);
